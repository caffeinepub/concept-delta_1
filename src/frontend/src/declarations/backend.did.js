...
export const idlService = IDL.Service({
  ...
  'createQuestion' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Text, IDL.Opt(ExternalBlob), IDL.Text, IDL.Nat],
      [],
      [],
    ),
  'createTest' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Text, IDL.Nat, IDL.Nat, IDL.Vec(IDL.Text)],
      [IDL.Text],
      [],
    ),
  ...
  'updateTestStatus' : IDL.Func([IDL.Text, IDL.Text], [], []),
});
